...
namespace NewProjectTemplate.ViewModels
{
    public class MainMenuViewModel : MvxViewModel
    {
        ...
        public override void Start()
        {
            ...
            {            
                new MenuItem("Daedalus", this) { Description = "Tap for more information."},
                new MenuItem("Eagle", this) { Description = "Tap for more information." },
                new MenuItem("Cro", this) { Description = "Tap for more information." },
                new MenuItem("Rhyno", this) { Description = "Tap for more information." }
            };
        }
